...
export const ElementPreview: React.FC<ElementPreviewProps> = ({ style }) => {
  return (
    <div className="p-8 lg:p-12 space-y-16 max-w-4xl mx-auto">
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-8 bg-slate-50 border border-slate-100 p-8 rounded-2xl">
      ...
      <section className="space-y-6">
        ...
        <div className="flex flex-wrap gap-6 items-start p-8 rounded-2xl border border-slate-200 shadow-sm bg-white">
          <button
            style={style}
